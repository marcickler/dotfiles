...
-- Use zsh for :terminal even when Neovim is launched from a bash environment.
...
require('lazy').setup({
  ...
  -- { 'sindrets/diffview.nvim' },
  {
    ...
    dependencies = {
      ...
      --"sindrets/diffview.nvim", -- Optional, but Neogit can hook into it if you ever change your mind
